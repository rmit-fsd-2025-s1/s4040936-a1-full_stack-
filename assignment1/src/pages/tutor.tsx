import {
    Box, Heading, Input, Select, Table, Thead, Tbody, Tr, Th, Td, Textarea, Button, useToast, SimpleGrid, Stat, StatLabel, StatNumber, Flex
      ...
      <>
        ...
        <Box maxW="90%" mx="auto" mt={8}>
          <Flex justifyContent="space-between" alignItems="center" mb={6}>
            <Heading>Tutor Applications Review</Heading>
